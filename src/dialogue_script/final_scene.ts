...
const scene: Line[] = [
  ...
  adam(
    "Om legenden stämmer så borde jag ju få träffa den Största spelmannen nu, och lära mig världens bästa låt."
  ),
  adam("..."),
  ...
  spegel(
    "Spelman, spelman på berget här, säg vem den främste av spelmännen är!"
  ),
  adam("Va?"),
  spegel(
    "Spelman, spelman på berget här, säg vem den främste av spelmännen är!"
  ...
  adam(
    "Jag hörde vad du sa, jag var bara inte alls beredd på att en spegel kunde prata."
  ),
  ...
  spegel("Feeel svaar!"),
  adam(
    "Jaha, jag trodde inte det fanns ett rätt och fel svar. Jag trodde det mer var en fråga om smak."
  ),
  spegel("Varför gjorde du den mödosamma resan upp på Stora Lokala Berget?"),
  adam("Heter det inte Stora Fjärran Berget?"),
  spegel(
    "Bara om man är långt bort från det. När man väl är där så är det ju inte fjärran."
  ),
  adam("Justja. Rimligt."),
  adam(
    "Jag gick upp hit för att träffa den störste av alla spelmän och lära mig världens bästa låt."
  ),
  spegel("Kom närmre."),
  ...
  adam("... Nu är jag lite närmre.", { otherAction: { type: "move" } }),
  spegel(
    "Den spelman som trotsar sin svaga kropp och vandrar längs stigen till bergets topp,"
  ),
  spegel(
    "den som bekämpar vårt fågelliv med svängiga låtar och kastad täljkniv"
  ),
  ...
  spegel(
    "Dessutom är du den enda som faktiskt lyckats. Alla andra blev facking nermejade av silkeshägern."
  ),
  // spegel('Molly och Oskar som designade spelet lyckades väl också på ett sätt medan de speltestade, men det är ju fusk.'),
  spegel(
    "Nu är stunden kommen. Nu ska du få en fiol med en C-sträng och komponera din egen låt i C, mästarnas tonart!"
  ),
